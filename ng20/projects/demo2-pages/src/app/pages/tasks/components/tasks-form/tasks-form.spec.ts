...
describe('TasksForm', () => {
  ...
  it('should disable submit button when form is invalid', () => {
    const button = fixture.nativeElement.querySelector('button');
    expect(component.taskNgForm()!.invalid).toBeTrue();
  ...
  it('should get datas from from controls', () => {
    ...
    const authorInput: HTMLInputElement =
      fixture.nativeElement.querySelector('input[name="author"]');
    titleInput.value = 'Test Title';
    authorInput.value = 'Test Author';
    titleInput.dispatchEvent(new Event('input'));
    authorInput.dispatchEvent(new Event('input'));
    fixture.detectChanges();
    expect(component.taskNgForm()!.value).toEqual({ title: 'Test Title', author: 'Test Author' });
  });
});
